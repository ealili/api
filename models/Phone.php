...
class Phone
{
    ...
    {
        // Create query
        $query = 'Update phone SET displayType = :displayType,
        displaySize = :displaySize, selfieCamera = :selfieCamera, displayResolution = :displayResolution, mainCamera = :mainCamera,
        technology = :technology, weight = :weight, sound = :sound,
        os = :os, productionYear = :productionYear, battery = :battery, imgSource = :imgSource WHERE id =
        :id';
        // Prepare statement
        $stmt = $this->conn->prepare($query);
